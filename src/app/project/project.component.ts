...
export class ProjectComponent  {
  ...
  projects:any=[
    {
      Name:"Car Insurance",
      Description:"A web-based car insurance management system using Angular, HTML, CSS, and Bootstrap.Designing and implementing the user interface to create a responsive and visually appealing application. Assisted in developing reusable components and services for data retrieval, validation, and manipulation, ensuring code organization and maintainability. Worked on integrating the application with backend APIs and implementing basic authentication features. gained practical experience in using Angular, Typescript, JavaScript, HTML, CSS, Bootstrap, Git.",
